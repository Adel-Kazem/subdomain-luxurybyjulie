                ...
                <nav class="fixed w-full z-50 bg-white/80 backdrop-blur-lg" x-data="{ isOpen: false }">
                    <div class="max-w-7xl mx-auto px-6 py-4">
                        <div class="flex items-center justify-between">
                            <!-- Logo - Brush Style with Primary Color -->
                            <a href="index.html" id="main-logo" class="text-3xl font-dancing text-primary brush-text rotate-on-hover transition-transform duration-300">LuxuryByJulie</a>
                            
                            <!-- Desktop Menu -->
                            <div class="hidden md:flex space-x-12">
                                <a href="index.html" id="nav-home" class="text-sm uppercase tracking-widest hover:text-primary" :class="activeLink === 'home' ? 'text-primary' : ''">Home</a>
                                <a href="products.html" id="nav-shop" class="text-sm uppercase tracking-widest hover:text-primary" :class="activeLink === 'shop' ? 'text-primary' : ''">Shop</a>
                                <a href="index.html#about" id="nav-about" class="text-sm uppercase tracking-widest hover:text-primary">About</a>
                                <a href="index.html#contact" id="nav-contact" class="text-sm uppercase tracking-widest hover:text-primary">Contact</a>
                            </div>
                            
                            <!-- Cart & Menu -->
                            <div class="flex items-center gap-6">
                                <a href="cart.html" class="relative" x-data :class="activeLink === 'cart' ? 'text-primary' : ''">
                                    <svg class="h-6 w-6">
                                        <use xlink:href="#icon-shopping-bag"></use>
                                    </svg>
                                    <span class="absolute -top-2 -right-2 bg-primary text-white text-xs w-5 h-5 rounded-full flex items-center justify-center" x-text="$store.cart.getTotalItems()">0</span>
                                </a>
                        ...
                        <div class="md:hidden" x-show="isOpen" 
                            ...
                            <div class="mt-4 flex flex-col space-y-6 py-6 px-4 bg-white rounded-lg shadow-lg">
                                <a href="index.html" id="mobile-nav-home" class="text-sm uppercase tracking-widest hover:text-primary" :class="activeLink === 'home' ? 'text-primary' : ''">Home</a>
                                <a href="products.html" id="mobile-nav-shop" class="text-sm uppercase tracking-widest hover:text-primary" :class="activeLink === 'shop' ? 'text-primary' : ''">Shop</a>
                                <a href="index.html#about" id="mobile-nav-about" class="text-sm uppercase tracking-widest hover:text-primary">About</a>
                                <a href="index.html#contact" id="mobile-nav-contact" class="text-sm uppercase tracking-widest hover:text-primary">Contact</a>
                            </div>
                        </div>
                    </div>
                </nav>
                ...
                <footer id="contact" class="bg-white py-20 px-6">
                    <div class="max-w-7xl mx-auto">
                        <div class="grid md:grid-cols-4 gap-12">
                            <div>
                                <h3 id="footer-logo" class="inline-block text-2xl font-dancing text-primary brush-text rotate-on-hover transition-transform duration-300 mb-6">LuxuryByJulie</h3>
                            ...
                            <div>
                                ...
                                <ul class="space-y-4 text-zinc-600">
                                    <li><a href="index.html" id="footer-link-home" class="hover:text-primary">Home</a></li>
                                    <li><a href="products.html" id="footer-link-shop" class="hover:text-primary">Shop</a></li>
                                    <li><a href="index.html#about" id="footer-link-about" class="hover:text-primary">About Us</a></li>
                                </ul>
                            </div>
                            <div>
                                <h4 id="footer-follow-us-heading" class="font-semibold mb-6">Follow Us</h4>
                                <ul class="space-y-4 text-zinc-600">
                                    <li><a href="#" id="footer-link-instagram" class="hover:text-primary">Instagram</a></li>
                                    <li><a href="#" id="footer-link-facebook" class="hover:text-primary">Facebook</a></li>
                                    <li><a href="#" id="footer-link-pinterest" class="hover:text-primary">Pinterest</a></li>
                                </ul>
                            </div>
                            <div>
                                ...
                                <address id="footer-address" class="text-zinc-600 not-italic mb-4">
                                    Beirut, Lebanon<br>
                                    <a href="mailto:info@luxurybyjulie.com" class="hover:text-primary">info@luxurybyjulie.com</a>
                                </address>
                                <p id="footer-whatsapp" class="text-zinc-600">
                                    WhatsApp: <a href="https://wa.me/96181874453" class="hover:text-primary">+961 81 874 453</a>
                                </p>
                            </div>
                        </div>
